...
use unocalc::utils::types::Operation;
...
fn test_addition() {
    ...
    calc.input_digit('3');
    calc.calculate();
    assert_eq!(calc.current_value(), 3.8);
}
...
fn test_subtraction() {
    ...
    calc.input_digit('2');
    calc.calculate();
    assert_eq!(calc.current_value(), 3.5);
}
...
fn test_multiplication() {
    ...
    calc.input_digit('2');
    calc.calculate();
    assert_eq!(calc.current_value(), 6.0);
}
...
fn test_division() {
    ...
    calc.input_digit('2');
    calc.calculate();
    assert_eq!(calc.current_value(), 3.0);
}
...
fn test_input_buffer() {
    ...
    calc.input_digit('.');
    calc.input_digit('5');
    assert_eq!(calc.input_buffer(), "1.5");
}
...
fn test_chained_operations() {
    ...
    calc.input_digit('4');
    calc.calculate();
    assert_eq!(calc.current_value(), 20.0); // (2 + 3) * 4 = 20
}
...
fn test_chained_operations_with_equals() {
    ...
    assert_eq!(calc.current_value(), 20.0);
}
...
fn test_division_by_zero() {
    ...
    calc.input_digit('0');
    calc.calculate();
    assert_eq!(calc.current_value(), 0.0); // Should return 0
}
